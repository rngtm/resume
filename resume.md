...
## 目標1. 活動の幅を広めたい
転職を経て、任せてもらえる仕事の幅が広がり、とても充実感を感じております。
より面白い仕事に関わるために、活動の幅を広めたいと感じております。

今後の目標としては、技術カンファレンスへの登壇を考えております。
...
## 目標2. 好きだと思えるものに関わりたい
プレイヤーとして、ものづくりに関わっていきたいと考えております。
仕事ではゲーム作りに関わる傍ら、
プライベートの時間でもゲームを作るという創作活動を行っております。

好きだと思えるものに関わることで、ユーザー視点で物をみることができ、
より良いプロダクトを作ることに寄与でき、仕事の実績を積みやすくなれると考えております。<br>
<br>

# 今後の目標と、現在の取り組みの相関
[]("drawio/objective.drawio")
