...
## 2022/12 ～ 現在 : C社
### 主な職務
- モバイルゲーム向けのグラフィックス開発業務
- Maya向けのシェーダー開発 <br>
- 新規プロジェクトのモック開発の一部を担当

### 業務内容
URP向けのレンダリングパイプラインの開発・設計業務を行っています。(例 : ScriptableRendererFeatureの追加)
必要に応じて、URP本体をカスタマイズすることもあります。
シェーダーの機能追加・ポストエフェクト開発・効率化のためのツール開発などの業務も行っています。
